...
class weather_api_client:
    ...
    def get_weather(self, city_name):
        ...
        # https://api.openweathermap.org/data/2.5/weather?q=Boston,US&appid=your-api-key
    ...
    def get_forecast(self, city_name):
        ...
        # https://api.openweathermap.org/data/2.5/forecast?q=Boston,US&appid=your-api-key
